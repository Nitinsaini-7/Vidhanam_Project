...
const Rti = () => {
  return (
    <div className="p-8 mx-auto">
      ...
      <p className="mb-4">
        RTI is a law that allows people to request information from government offices. It ensures transparency and holds the government accountable for its actions.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">Who can file an RTI application?</h2>
      <p className="mb-4">
        Any citizen of India can file an RTI application. Organizations or companies cannot file RTIs, but an individual can do so on their behalf.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">What information can I ask for under RTI?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">How can I file an RTI application?</h2>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">What are the fees for filing an RTI?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">Can I ask questions about private companies under RTI?</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">Can someone file an RTI on my behalf?</h2>
      <p className="mb-4">
        No, the RTI must be filed by you. However, you can get help from someone to draft the application.
      </p>
      ...
      <h2 className="text-2xl font-semibold mt-8 mb-4">Is there any format for filing RTI?</h2>
      <p className="mb-4">
        There’s no fixed format for an RTI application. Just write your questions in simple language, include your contact details, and address it to the relevant Public Information Officer (PIO).
      </p>
    </div>
  );
};
